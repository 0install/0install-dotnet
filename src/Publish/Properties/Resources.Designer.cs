...
namespace ZeroInstall.Publish.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The feed already contains an implementation with the ID '{0}'..
        /// </summary>
        internal static string DuplicateImplementationID {
            get {
                return ResourceManager.GetString("DuplicateImplementationID", resourceCulture);
            }
        }
