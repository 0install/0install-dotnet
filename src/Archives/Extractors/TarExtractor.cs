...
public partial class TarExtractor : ArchiveExtractor
{
    ...
    public override void Extract(IBuilder builder, Stream stream, string? subDir = null)
    {
        ...
        catch (Exception ex) when (ex is SharpZipBaseException or InvalidDataException or ArgumentOutOfRangeException or IndexOutOfRangeException or {Message: "Data Error"} or NotImplementedException)
        {
