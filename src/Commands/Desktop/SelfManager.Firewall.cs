...
partial class SelfManager
{
    private const string
        ...
        FirewallDiscoveryService = "Zero Install - Service discovery (0store-service)";
    ...
    private void FirewallRulesApply()
    {
        ...
        Handler.RunTask(new ActionTask("Configuring Windows Firewall", () =>
        {
            ...
            FirewallAddRule(FirewallDiscoveryService, target: ("service", "0store-service"), protocol: mDns);
        }));
    }
    ...
    private void FirewallRulesRemove()
    {
        ...
        Handler.RunTask(new ActionTask("Configuring Windows Firewall", () =>
        {
            ...
            FirewallRemoveRule(FirewallDiscoveryService);
        }));
    }
