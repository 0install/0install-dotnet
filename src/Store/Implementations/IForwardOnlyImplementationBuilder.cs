...
{
    /// <summary>
    /// Builds an implementation without changing or removing elements that have already been added.
    /// </summary>
    public interface IForwardOnlyImplementationBuilder
    {
        /// <summary>
        ...
        /// <exception cref="UnauthorizedAccessException">Access to a resource was denied.</exception>
        /// <exception cref="IOException">An IO operation failed.</exception>
        /// <exception cref="NotSupportedException">This builder does not support hardlinks. Use <see cref="AddFile"/> instead.</exception>
