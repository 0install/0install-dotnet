...
namespace ZeroInstall.Store.Implementations
{
    ...
    public class DirectoryBuilder : MarshalNoTimeout, IBuilder
    {
        ...
        {
            if (Manifest.RejectPath(relativePath)) throw new IOException(string.Format(Resources.ArchiveInvalidPath, relativePath));
            ...
            if (!fullPath.StartsWith(allowedRoot + System.IO.Path.DirectorySeparatorChar))
                throw new IOException(string.Format(Resources.ArchiveInvalidPath, relativePath));
