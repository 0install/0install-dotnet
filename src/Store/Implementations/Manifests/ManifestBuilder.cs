...
{
    /// <summary>
    /// Builds a <see cref="Manifest"/> for an implementation.
    /// </summary>
    public class ManifestBuilder : IImplementationBuilder
    {
        /// <summary>
        /// The manifest.
        /// </summary>
        ...
        public void Rename(string path, string target)
        {
            ...
            if (!Manifest.RenameRecursive(path.ToUnixPath(), target.ToUnixPath()))
        ...
        public void Remove(string path)
        {
            ...
            if (!Manifest.RemoveRecursive(path.ToUnixPath()))
                throw new IOException(string.Format(Resources.FileOrDirNotFound, path));
        }
