...
namespace ZeroInstall.Store.Implementations.Manifests
{
    ...
    [Serializable]
    public sealed record ManifestNormalFile(string Digest, long ModifiedTimeUnix, long Size, string Name)
        : ManifestFileBase(Digest, ModifiedTimeUnix, Size, Name)
    {
        ...
        public override string ToString()
            => string.Format(CultureInfo.InvariantCulture, "F {0} {1} {2} {3}", Digest, ModifiedTimeUnix, Size, Name);
    }
}
