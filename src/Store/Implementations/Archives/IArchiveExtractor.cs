...
namespace ZeroInstall.Store.Implementations.Archives
{
    ...
    public interface IArchiveExtractor
    {
        ...
        /// <param name="stream">The stream containing the archive data to be extracted.</param>
        ...
        void Extract(IImplementationBuilder builder, Stream stream, string? subDir = null);
