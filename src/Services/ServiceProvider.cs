...
public class ServiceProvider
{
    ...
    public ServiceProvider(ITaskHandler handler)
    {
        ...
        _solver = new(() => Config.PreferNewSolver ? new SatSolver(SelectionCandidateProvider) : new FallbackSolver(new BacktrackingSolver(SelectionCandidateProvider), new SatSolver(SelectionCandidateProvider)));
