...
namespace ZeroInstall.Services.Fetchers
{
    ...
    public abstract class FetcherTestBase : TestWithMocks
    {
        protected static readonly Stream ZipArchiveStream = typeof(FetcherTestBase).GetEmbeddedStream("testArchive.zip");
