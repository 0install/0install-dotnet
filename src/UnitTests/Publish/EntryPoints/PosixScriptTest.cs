...
namespace ZeroInstall.Publish.EntryPoints
{
    ...
    public class PosixScriptTest : CandidateTest
    {
        ...
        [Fact]
        public void NotExecutable() => new PosixScript().Analyze(baseDirectory: Directory, file: Deploy(Reference, xbit: false))
            .Should().BeFalse();

        [Fact]
        public void NoShebang() => new PosixScript().Analyze(baseDirectory: Directory, file: Deploy(WindowsExeTest.Reference32, xbit: true))
            .Should().BeFalse();
    }
}
