...
internal class InstallCommandsConverter : ValueTypeConverter<InstallCommands>
{
    ...
    private static readonly ConstructorInfo _constructor = typeof(InstallCommands).GetConstructor([typeof(string), typeof(string), typeof(string), typeof(string)])!;
    ...
    protected override object[] GetArguments(InstallCommands value)
        => [value.Reinstall!, value.ReinstallArgs!, value.ShowIcons!, value.ShowIconsArgs!, value.HideIcons!, value.HideIconsArgs!];
